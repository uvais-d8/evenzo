...
import { authController as authCtrl, adminController as adminCtrl } from '../controllers';
import { authenticate, authorize } from '../middleware/auth.middleware';
import { Role } from '../../domain/enums/enums';
import { validateRequest } from '../middleware/validation.middleware';
import { loginSchema, verifyVendorSchema } from '../../application/utils/validation';
...
router.put('/vendors/:vendorId/verify', authenticate, authorize([Role.ADMIN]), validateRequest(verifyVendorSchema), adminCtrl.verifyVendor);
