...
import { eventSchema } from '../../application/utils/validation';
...
// VENDOR ONLY
router.post('/', authenticate, authorize([Role.VENDOR]), upload.array('images', 5), validateRequest(eventSchema), eventCtrl.createEvent);
