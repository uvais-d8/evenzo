            ...
            <div style={styles.card}>
                <div style={styles.header}>
                    <div>
                        ...
                        <p style={styles.subtitle}>Showcase your best events and services to attract more clients.</p>
                    </div>
                    <button style={styles.uploadBtn}>Upload New Sample</button>
                </div>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    subtitle: { fontSize: '13px', color: '#64748b', margin: 0, fontWeight: 300 },
    uploadBtn: { backgroundColor: '#2563eb', color: 'white', border: 'none', padding: '10px 25px', borderRadius: '10px', fontSize: '12px', fontWeight: 500, cursor: 'pointer', boxShadow: '0 6px 15px rgba(37, 99, 235, 0.2)', textTransform: 'uppercase', letterSpacing: '0.05em' },
