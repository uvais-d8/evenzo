    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            const [eventsRes, catsRes] = await Promise.all([
                eventRepository.getEvents({ vendorId: JSON.parse(sessionStorage.getItem("userData") || "{}").id }),
        ...
        <div style={styles.container}>
            <div style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>Create and manage your hosted events</p>
                </div>
                ...
                <div style={styles.grid}>
                    {events.map(event => (
                        <div key={event._id} style={styles.card}>
                            <img src={event.image || '/placeholder.jpg'} alt={event.title} style={styles.eventImage} />
                            <div style={styles.cardContent}>
                                ...
                                <div style={styles.cardActions}>
                                    ...
                                    <button style={{...styles.iconBtn, color: '#ef4444'}}><FiTrash2 /></button>
                                </div>
                            </div>
                        </div>
                    ))}
...
const styles: Record<string, React.CSSProperties> = {
    ...
    textarea: { padding: '12px', borderRadius: '10px', border: '1px solid #e2e8f0', minHeight: '80px', fontSize: '13px', outline: 'none', resize: 'none' },
    ...
    emptyState: { textAlign: 'center', padding: '50px', backgroundColor: '#f8fafc', borderRadius: '20px', border: '2px dashed #e2e8f0', color: '#94a3b8' }
};
