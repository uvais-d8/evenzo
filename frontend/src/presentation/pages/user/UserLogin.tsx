...
function UserLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const res = await authApi.login(Role.USER, formData);
    ...
    const loginWithGoogle = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            setIsLoading(true);
            try {
                const res = await authApi.googleLogin(tokenResponse.access_token, Role.USER);
                const { token, refreshToken, user } = res.data;
                sessionStorage.setItem("token", token);
                sessionStorage.setItem("refreshToken", refreshToken);
                sessionStorage.setItem("userRole", Role.USER);
            ...
            <div style={styles.wrapper}>
                <div style={styles.container}>
                    ...
                    <div style={styles.formSection}>
                        ...
                        <p style={styles.subtitle}>Please enter your details below</p>
